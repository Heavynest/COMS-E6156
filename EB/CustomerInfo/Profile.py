...
class ProfileService(BaseService):
    ...
    valid_element_type = ['PHONE', 'ADDRESS', 'EMAIL', 'OTHER']
    ...
    def validate_profile(cls, profile_info):
        ...
        if profile_info.get('element_subtype') is not None and profile_info.get('element_subtype') not in ProfileService.valid_element_sub_type:
            raise ServiceException(ServiceException.bad_data,
        ...
        if profile_info.get('element_type') == 'PHONE' and not profile_info.get('element_value').isdigit():
            raise ServiceException(ServiceException.bad_data,
